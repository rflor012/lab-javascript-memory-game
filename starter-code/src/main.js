...
$(document).ready(function(){
  ...
  $('.back').on('click', function(){
    console.log(theGame);
    $(this).toggle(); //this means display = none
    $(this).parent().find(".front").toggle(); //from display none to display something, find me the div i clicked, then find me the parent, and card
